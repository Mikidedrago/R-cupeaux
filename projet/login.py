...
"font-size: 16px")
        ...
        self.icone = QtWidgets.QLabel(self.frame)
        self.icone.setGeometry(QtCore.QRect(93, 390, 21, 21))
        self.icone.setStyleSheet("background-image: url(:/images/Fond/attention.png);")
        self.icone.setText("")
        self.icone.setObjectName("label_2")
        self.icone.hide()
