...
# Dialog implementation generated from reading ui file 'principale.ui'
#
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Localisation cuve"))
        self.label.setText(_translate("Dialog", "X"))
        self.label_2.setText(_translate("Dialog", "°C"))
        self.boutonDeconnexion.setText(_translate("Dialog", "Deconnexion"))
        self.boutonSeConnecter_2.setText(_translate("Dialog", "Quitter"))
